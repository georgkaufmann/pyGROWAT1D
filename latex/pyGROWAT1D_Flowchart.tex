...
\item readParameter1D()
\item readBC1D()
\item readMaterials1D()
\end{itemize}
};
...
\setlength\itemsep{-0.5em}
\item buildHEADBC1D()
\item buildHeadEquations1D\_\{ss,t\}()
\item solveLinearSystem1D()
\item solveVelocities1D()
\item saveHeadsAndVelocities1D()
\item plotHeadsAndVelocities1D()
\end{itemize}
};
